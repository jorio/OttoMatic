...
[kNeed_PrevWeapon		] = { { SC(RSHIFT)	, 0				}, MB(WHEELUP)	, { CB(LEFTSHOULDER)	, CBNULL()				} },
[kNeed_NextWeapon		] = { { SC(LSHIFT)	, 0				}, MB(WHEELDOWN), { CB(RIGHTSHOULDER)	, CBNULL()				} },
...
[kNeed_TextEntry_End	] = { { SC(HOME)	, 0				}, 0			, { CBNULL()			, CBNULL()				} },
